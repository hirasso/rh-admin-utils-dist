...
use RH\AdminUtils\Scoped\Snicco\Component\BetterWPCLI\Synopsis\InputFlag;
...
abstract class Command
{
    ...
    {
        return [new InputFlag('v', 'Verbose output'), new InputFlag('vv', 'More verbose output'), new InputFlag('vvv', 'Maximum verbosity (equal to --debug)')];
    }
