...
final class AnsiColors
{
     ...
     */
    private const COLORS = ['color' => ['black' => 30, 'red' => 31, 'green' => 32, 'yellow' => 33, 'blue' => 34, 'magenta' => 35, 'cyan' => 36, 'white' => 37], 'style' => ['bright' => 1, 'dim' => 2, 'underline' => 4, 'blink' => 5, 'reverse' => 7, 'hidden' => 8], 'background' => ['black' => 40, 'red' => 41, 'green' => 42, 'yellow' => 43, 'blue' => 44, 'magenta' => 45, 'cyan' => 46, 'white' => 47]];
    /**
     * @var array<string,array{color?:string, style?: string, background?: string}>
     */
    private const COLOR_MAP = ['%y' => ['color' => 'yellow'], '%g' => ['color' => 'green'], '%b' => ['color' => 'blue'], '%r' => ['color' => 'red'], '%m' => ['color' => 'magenta'], '%c' => ['color' => 'cyan'], '%w' => ['color' => 'white'], '%k' => ['color' => 'black'], '%n' => ['color' => 'reset'], '%Y' => ['color' => 'yellow', 'style' => 'bright'], '%G' => ['color' => 'green', 'style' => 'bright'], '%B' => ['color' => 'blue', 'style' => 'bright'], '%R' => ['color' => 'red', 'style' => 'bright'], '%M' => ['color' => 'magenta', 'style' => 'bright'], '%C' => ['color' => 'cyan', 'style' => 'bright'], '%W' => ['color' => 'white', 'style' => 'bright'], '%K' => ['color' => 'black', 'style' => 'bright'], '%N' => ['color' => 'reset', 'style' => 'bright'], '%3' => ['background' => 'yellow'], '%2' => ['background' => 'green'], '%4' => ['background' => 'blue'], '%1' => ['background' => 'red'], '%5' => ['background' => 'magenta'], '%6' => ['background' => 'cyan'], '%7' => ['background' => 'white'], '%0' => ['background' => 'black'], '%F' => ['style' => 'blink'], '%U' => ['style' => 'underline'], '%8' => ['style' => 'reverse'], '%9' => ['style' => 'bright']];
    private bool $colorize;
    /**
     * @var array<string,string>
     */
    private array $cache = [];
    public function __construct(bool $colorize = \true)
    {
    ...
    {
        $color_definition = array_replace(['color' => null, 'style' => null, 'background' => null], $color_definition);
