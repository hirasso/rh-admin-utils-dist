...
final class InputOption implements InputDefinition
{
     ...
     */
    public function __construct(string $name, string $description = '', int $flags = self::OPTIONAL, string $default = null, array $allowed_values = null)
    {
    ...
    {
        $data = ['type' => 'assoc', 'name' => $this->name, 'description' => $this->description, 'optional' => $this->optional];
