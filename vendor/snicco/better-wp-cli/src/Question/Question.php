...
namespace RH\AdminUtils\Scoped\Snicco\Component\BetterWPCLI\Question;
...
final class Question
{
     ...
     */
    public function __construct(string $question, string $default = '', callable $validator = null, int $attempts = null, callable $normalizer = null, bool $hidden = \false, bool $allow_visible_fallback = \false)
    {
    ...
    public function withHiddenInput(bool $hidden = \true): self
    {
        $new = clone $this;
        $new->hidden = $hidden;
        return $new;
    ...
    public function withFallbackVisibleInput(bool $allow_visible = \true): self
    {
        $new = clone $this;
