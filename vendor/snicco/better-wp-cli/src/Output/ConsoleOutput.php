...
use RH\AdminUtils\Scoped\Snicco\Component\BetterWPCLI\Verbosity;
...
final class ConsoleOutput extends OutputWithVerbosity implements ConsoleOutputInterface
{
    ...
    public function __construct(int $verbosity = Verbosity::NORMAL, bool $colors_stdout = null, bool $colors_stderr = null)
    {
