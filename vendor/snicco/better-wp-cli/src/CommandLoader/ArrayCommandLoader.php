...
namespace RH\AdminUtils\Scoped\Snicco\Component\BetterWPCLI\CommandLoader;

use ReflectionClass;
use ReflectionException;
use RH\AdminUtils\Scoped\Snicco\Component\BetterWPCLI\Command;
use RH\AdminUtils\Scoped\Snicco\Component\BetterWPCLI\Exception\CommandNotFound;
...
final class ArrayCommandLoader implements CommandLoader
{
    ...
    {
        if (!in_array($command_class, $this->command_classes, \true)) {
