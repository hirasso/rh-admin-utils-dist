 ...
 */
namespace RH\AdminUtils\Scoped\Symfony\Component\String\Inflector;
...
final class FrenchInflector implements InflectorInterface
{
    ...
    private const PLURALIZE_REGEXP = [
        ...
        // French titles
        ['/^(mon|ma)(sieur|dame|demoiselle|seigneur)$/', 'RH\AdminUtils\Scoped\mes\2s'],
        ['/^(Mon|Ma)(sieur|dame|demoiselle|seigneur)$/', 'RH\AdminUtils\Scoped\Mes\2s'],
    ];
    /**
    ...
    private const SINGULARIZE_REGEXP = [
        ...
        // French titles
        ['/^mes(dame|demoiselle)s$/', 'RH\AdminUtils\Scoped\ma\1'],
        ['/^Mes(dame|demoiselle)s$/', 'RH\AdminUtils\Scoped\Ma\1'],
        ['/^mes(sieur|seigneur)s$/', 'RH\AdminUtils\Scoped\mon\1'],
        ['/^Mes(sieur|seigneur)s$/', 'RH\AdminUtils\Scoped\Mon\1'],
        // Default rule
        ['/s$/i', ''],
    ];
