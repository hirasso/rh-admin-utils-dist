 ...
 */
namespace RH\AdminUtils\Scoped\Symfony\Component\EventDispatcher\Debug;

use RH\AdminUtils\Scoped\Psr\EventDispatcher\StoppableEventInterface;
use RH\AdminUtils\Scoped\Psr\Log\LoggerInterface;
use RH\AdminUtils\Scoped\Symfony\Component\EventDispatcher\EventDispatcher;
use RH\AdminUtils\Scoped\Symfony\Component\EventDispatcher\EventDispatcherInterface;
use RH\AdminUtils\Scoped\Symfony\Component\EventDispatcher\EventSubscriberInterface;
...
use RH\AdminUtils\Scoped\Symfony\Component\Stopwatch\Stopwatch;
...
class TraceableEventDispatcher implements EventDispatcherInterface, ResetInterface
{
    ...
    public function __construct(private EventDispatcherInterface $dispatcher, protected Stopwatch $stopwatch, protected ?LoggerInterface $logger = null, private ?RequestStack $requestStack = null)
    {
    }
