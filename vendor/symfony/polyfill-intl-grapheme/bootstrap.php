 ...
 */
use RH\AdminUtils\Scoped\Symfony\Polyfill\Intl\Grapheme as p;
...
if (!\function_exists('grapheme_extract') && !\function_exists('RH\AdminUtils\Scoped\grapheme_extract')) {
...
if (!\function_exists('grapheme_stripos') && !\function_exists('RH\AdminUtils\Scoped\grapheme_stripos')) {
    function grapheme_stripos($haystack, $needle, $offset = 0)
    {
        return p\Grapheme::grapheme_stripos($haystack, $needle, $offset);
    }
}
if (!\function_exists('grapheme_stristr') && !\function_exists('RH\AdminUtils\Scoped\grapheme_stristr')) {
...
if (!\function_exists('grapheme_strlen') && !\function_exists('RH\AdminUtils\Scoped\grapheme_strlen')) {
    function grapheme_strlen($input)
    {
        return p\Grapheme::grapheme_strlen($input);
    }
}
if (!\function_exists('grapheme_strpos') && !\function_exists('RH\AdminUtils\Scoped\grapheme_strpos')) {
    function grapheme_strpos($haystack, $needle, $offset = 0)
    {
        return p\Grapheme::grapheme_strpos($haystack, $needle, $offset);
    }
}
if (!\function_exists('grapheme_strripos') && !\function_exists('RH\AdminUtils\Scoped\grapheme_strripos')) {
    function grapheme_strripos($haystack, $needle, $offset = 0)
    {
        return p\Grapheme::grapheme_strripos($haystack, $needle, $offset);
    }
}
if (!\function_exists('grapheme_strrpos') && !\function_exists('RH\AdminUtils\Scoped\grapheme_strrpos')) {
    function grapheme_strrpos($haystack, $needle, $offset = 0)
    {
        return p\Grapheme::grapheme_strrpos($haystack, $needle, $offset);
    }
}
if (!\function_exists('grapheme_strstr') && !\function_exists('RH\AdminUtils\Scoped\grapheme_strstr')) {
...
if (!\function_exists('grapheme_substr') && !\function_exists('RH\AdminUtils\Scoped\grapheme_substr')) {
