 ...
 */
use RH\AdminUtils\Scoped\Symfony\Polyfill\Intl\Normalizer as p;
if (!\function_exists('normalizer_is_normalized') && !\function_exists('RH\AdminUtils\Scoped\normalizer_is_normalized')) {
...
if (!\function_exists('normalizer_normalize') && !\function_exists('RH\AdminUtils\Scoped\normalizer_normalize')) {
