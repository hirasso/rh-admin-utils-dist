...
class DOMCaster
{
    ...
    public static function castException(\DOMException|\RH\AdminUtils\Scoped\Dom\Exception $e, array $a, Stub $stub, bool $isNested): array
    {
    ...
    public static function castImplementation(\DOMImplementation|\RH\AdminUtils\Scoped\Dom\Implementation $dom, array $a, Stub $stub, bool $isNested): array
    {
        $a += [Caster::PREFIX_VIRTUAL . 'Core' => '1.0', Caster::PREFIX_VIRTUAL . 'XML' => '2.0'];
        return $a;
    }
    public static function castNode(\DOMNode|\RH\AdminUtils\Scoped\Dom\Node $dom, array $a, Stub $stub, bool $isNested): array
    {
        ...
        if ($dom instanceof \DOMNode || $dom instanceof \RH\AdminUtils\Scoped\Dom\Element) {
    ...
    public static function castXMLDocument(\RH\AdminUtils\Scoped\Dom\XMLDocument $dom, array $a, Stub $stub, bool $isNested, int $filter = 0): array
    {
    ...
    public static function castHTMLDocument(\RH\AdminUtils\Scoped\Dom\HTMLDocument $dom, array $a, Stub $stub, bool $isNested, int $filter = 0): array
    {
    ...
    public static function castCharacterData(\DOMCharacterData|\RH\AdminUtils\Scoped\Dom\CharacterData $dom, array $a, Stub $stub, bool $isNested): array
    {
        $a += ['data' => $dom->data, 'length' => $dom->length];
        return $a;
    }
    public static function castAttr(\DOMAttr|\RH\AdminUtils\Scoped\Dom\Attr $dom, array $a, Stub $stub, bool $isNested): array
    {
    ...
    public static function castElement(\DOMElement|\RH\AdminUtils\Scoped\Dom\Element $dom, array $a, Stub $stub, bool $isNested): array
    {
    ...
    public static function castText(\DOMText|\RH\AdminUtils\Scoped\Dom\Text $dom, array $a, Stub $stub, bool $isNested): array
    {
        $a += ['wholeText' => $dom->wholeText];
        return $a;
    }
    public static function castDocumentType(\DOMDocumentType|\RH\AdminUtils\Scoped\Dom\DocumentType $dom, array $a, Stub $stub, bool $isNested): array
    {
    ...
    public static function castNotation(\DOMNotation|\RH\AdminUtils\Scoped\Dom\Notation $dom, array $a, Stub $stub, bool $isNested): array
    {
        $a += ['publicId' => $dom->publicId, 'systemId' => $dom->systemId];
        return $a;
    }
    public static function castEntity(\DOMEntity|\RH\AdminUtils\Scoped\Dom\Entity $dom, array $a, Stub $stub, bool $isNested): array
    {
    ...
    public static function castProcessingInstruction(\DOMProcessingInstruction|\RH\AdminUtils\Scoped\Dom\ProcessingInstruction $dom, array $a, Stub $stub, bool $isNested): array
    {
        $a += ['target' => $dom->target, 'data' => $dom->data];
        return $a;
    }
    public static function castXPath(\DOMXPath|\RH\AdminUtils\Scoped\Dom\XPath $dom, array $a, Stub $stub, bool $isNested): array
    {
