 ...
 */
namespace RH\AdminUtils\Scoped\Symfony\Component\Process;

use RH\AdminUtils\Scoped\Symfony\Component\Process\Exception\InvalidArgumentException;
use RH\AdminUtils\Scoped\Symfony\Component\Process\Exception\LogicException;
use RH\AdminUtils\Scoped\Symfony\Component\Process\Exception\ProcessFailedException;
use RH\AdminUtils\Scoped\Symfony\Component\Process\Exception\ProcessSignaledException;
use RH\AdminUtils\Scoped\Symfony\Component\Process\Exception\ProcessStartFailedException;
use RH\AdminUtils\Scoped\Symfony\Component\Process\Exception\ProcessTimedOutException;
use RH\AdminUtils\Scoped\Symfony\Component\Process\Exception\RuntimeException;
use RH\AdminUtils\Scoped\Symfony\Component\Process\Pipes\UnixPipes;
use RH\AdminUtils\Scoped\Symfony\Component\Process\Pipes\WindowsPipes;
/**
...
class Process implements \IteratorAggregate
{
    ...
    {
        if (!\function_exists('proc_open') && !\function_exists('RH\AdminUtils\Scoped\proc_open')) {
    ...
    protected function isSigchildEnabled(): bool
    {
        ...
        if (!\function_exists('phpinfo') && !\function_exists('RH\AdminUtils\Scoped\phpinfo')) {
