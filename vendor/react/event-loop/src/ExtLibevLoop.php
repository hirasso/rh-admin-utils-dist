...
namespace RH\AdminUtils\Scoped\React\EventLoop;

use BadMethodCallException;
use RH\AdminUtils\Scoped\libev\EventLoop;
use RH\AdminUtils\Scoped\libev\IOEvent;
use RH\AdminUtils\Scoped\libev\SignalEvent;
use RH\AdminUtils\Scoped\libev\TimerEvent;
use RH\AdminUtils\Scoped\React\EventLoop\Tick\FutureTickQueue;
use RH\AdminUtils\Scoped\React\EventLoop\Timer\Timer;
...
final class ExtLibevLoop implements LoopInterface
{
    ...
    {
        if (!\class_exists('RH\AdminUtils\Scoped\libev\EventLoop', \false)) {
