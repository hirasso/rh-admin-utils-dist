...
use RH\AdminUtils\Scoped\React\Promise;
...
final class SecureConnector implements ConnectorInterface
{
    ...
    {
        if (!\function_exists('stream_socket_enable_crypto') && !\function_exists('RH\AdminUtils\Scoped\stream_socket_enable_crypto')) {
        ...
        return new \RH\AdminUtils\Scoped\React\Promise\Promise(function ($resolve, $reject) use ($promise) {
