...
namespace RH\AdminUtils\Scoped\React\Socket;

use RH\AdminUtils\Scoped\React\Dns\Config\Config as DnsConfig;
use RH\AdminUtils\Scoped\React\Dns\Resolver\Factory as DnsFactory;
use RH\AdminUtils\Scoped\React\Dns\Resolver\ResolverInterface;
...
final class Connector implements ConnectorInterface
{
    ...
    public function connect($uri)
    {
        ...
        if (!isset($this->connectors[$scheme])) {
            return \RH\AdminUtils\Scoped\React\Promise\reject(new \RuntimeException('No connector available for URI scheme "' . $scheme . '" (EINVAL)', \defined('SOCKET_EINVAL') ? \SOCKET_EINVAL : (\defined('PCNTL_EINVAL') ? \PCNTL_EINVAL : 22)));
        }
