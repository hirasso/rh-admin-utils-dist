...
namespace RH\AdminUtils\Scoped\React\Dns\Resolver;

use RH\AdminUtils\Scoped\React\Cache\ArrayCache;
use RH\AdminUtils\Scoped\React\Cache\CacheInterface;
use RH\AdminUtils\Scoped\React\Dns\Config\Config;
use RH\AdminUtils\Scoped\React\Dns\Config\HostsFile;
use RH\AdminUtils\Scoped\React\Dns\Query\CachingExecutor;
use RH\AdminUtils\Scoped\React\Dns\Query\CoopExecutor;
use RH\AdminUtils\Scoped\React\Dns\Query\ExecutorInterface;
use RH\AdminUtils\Scoped\React\Dns\Query\FallbackExecutor;
use RH\AdminUtils\Scoped\React\Dns\Query\HostsFileExecutor;
use RH\AdminUtils\Scoped\React\Dns\Query\RetryExecutor;
use RH\AdminUtils\Scoped\React\Dns\Query\SelectiveTransportExecutor;
use RH\AdminUtils\Scoped\React\Dns\Query\TcpTransportExecutor;
use RH\AdminUtils\Scoped\React\Dns\Query\TimeoutExecutor;
use RH\AdminUtils\Scoped\React\Dns\Query\UdpTransportExecutor;
use RH\AdminUtils\Scoped\React\EventLoop\Loop;
use RH\AdminUtils\Scoped\React\EventLoop\LoopInterface;
final class Factory
{
    /**
