...
namespace RH\AdminUtils\Psr\Log\Test;

use RH\AdminUtils\Psr\Log\LoggerInterface;
use RH\AdminUtils\Psr\Log\LogLevel;
use RH\AdminUtils\PHPUnit\Framework\TestCase;
/**
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('RH\AdminUtils\Psr\Log\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('RH\AdminUtils\Psr\Log\Test\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('RH\AdminUtils\Psr\Log\Test\DummyTest', array('__toString'));
        }
