...
namespace RH\AdminUtils\Scoped\Psr\Log\Test;

use RH\AdminUtils\Scoped\Psr\Log\LoggerInterface;
use RH\AdminUtils\Scoped\Psr\Log\LogLevel;
use RH\AdminUtils\Scoped\PHPUnit\Framework\TestCase;
/**
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('RH\AdminUtils\Scoped\Psr\Log\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('RH\AdminUtils\Scoped\Psr\Log\Test\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('RH\AdminUtils\Scoped\Psr\Log\Test\DummyTest', array('__toString'));
        }
