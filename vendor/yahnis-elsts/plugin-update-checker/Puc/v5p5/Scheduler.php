...
if (!class_exists(\YahnisElsts\PluginUpdateChecker\v5p5\Scheduler::class, \false)) {
    /**
    ...
    class Scheduler
    {
        ...
        )
        {
            ...
            if (is_a($this->updateChecker, \YahnisElsts\PluginUpdateChecker\v5p5\Theme\UpdateChecker::class)) {
            ...
            if (is_a($this->updateChecker, \YahnisElsts\PluginUpdateChecker\v5p5\Plugin\UpdateChecker::class)) {
        ...
        public function maybeCheckForUpdates()
        {
            ...
            if ($shouldCheck) {
                ...
                if (!(class_exists(\YahnisElsts\PluginUpdateChecker\v5p5\Utils::class) && class_exists(\YahnisElsts\PluginUpdateChecker\v5p5\Metadata::class) && class_exists(\YahnisElsts\PluginUpdateChecker\v5p5\Plugin\Update::class) && class_exists(\YahnisElsts\PluginUpdateChecker\v5p5\Theme\Update::class))) {
                    return;
                }
            }
