...
if (!class_exists(\YahnisElsts\PluginUpdateChecker\v5p5\DebugBar\Extension::class, \false)) {
    class Extension
    {
        const RESPONSE_BODY_LENGTH_LIMIT = 4000;
        /** @var UpdateChecker */
        protected $updateChecker;
        protected $panelClass = \YahnisElsts\PluginUpdateChecker\v5p5\DebugBar\Panel::class;
