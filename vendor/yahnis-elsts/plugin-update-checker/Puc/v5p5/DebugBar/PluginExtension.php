...
if (!class_exists(\YahnisElsts\PluginUpdateChecker\v5p5\DebugBar\PluginExtension::class, \false)) {
    class PluginExtension extends \YahnisElsts\PluginUpdateChecker\v5p5\DebugBar\Extension
    {
        /** @var UpdateChecker */
        protected $updateChecker;
        public function __construct($updateChecker)
        {
            parent::__construct($updateChecker, \YahnisElsts\PluginUpdateChecker\v5p5\DebugBar\PluginPanel::class);
