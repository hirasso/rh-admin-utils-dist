...
namespace RH\AdminUtils\Scoped\YahnisElsts\PluginUpdateChecker\v5p5\DebugBar;

use RH\AdminUtils\Scoped\YahnisElsts\PluginUpdateChecker\v5p5\UpdateChecker;
if (!class_exists(Panel::class, \false) && class_exists('RH\AdminUtils\Scoped\Debug_Bar_Panel', \false)) {
    class Panel extends \RH\AdminUtils\Scoped\Debug_Bar_Panel
    {
        /** @var UpdateChecker */
