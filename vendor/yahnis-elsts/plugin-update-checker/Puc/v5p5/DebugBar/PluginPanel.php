...
if (!class_exists(\YahnisElsts\PluginUpdateChecker\v5p5\DebugBar\PluginPanel::class, \false)) {
    class PluginPanel extends \YahnisElsts\PluginUpdateChecker\v5p5\DebugBar\Panel
    {
        /**
         * @var UpdateChecker
         */
