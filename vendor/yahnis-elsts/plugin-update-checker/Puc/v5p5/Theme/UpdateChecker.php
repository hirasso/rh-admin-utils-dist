...
if (!class_exists(\YahnisElsts\PluginUpdateChecker\v5p5\Theme\UpdateChecker::class, \false)) {
    class UpdateChecker extends BaseUpdateChecker
    {
        ...
        {
            list($themeUpdate, $result) = $this->requestMetadata(\YahnisElsts\PluginUpdateChecker\v5p5\Theme\Update::class, 'request_update');
            if ($themeUpdate !== null) {
        ...
        {
            return new \YahnisElsts\PluginUpdateChecker\v5p5\Theme\Package($this->stylesheet, $this);
        }
    }
}
