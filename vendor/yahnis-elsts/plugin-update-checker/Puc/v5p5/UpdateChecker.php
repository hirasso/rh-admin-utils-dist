...
use stdClass;
use WP_Error;
if (!class_exists(\YahnisElsts\PluginUpdateChecker\v5p5\UpdateChecker::class, \false)) {
    abstract class UpdateChecker
    {
        ...
        public function __construct($metadataUrl, $directoryName, $slug = null, $checkPeriod = 12, $optionName = '')
        {
            ...
            $this->upgraderStatus = new \YahnisElsts\PluginUpdateChecker\v5p5\UpgraderStatus();
            $this->updateState = new \YahnisElsts\PluginUpdateChecker\v5p5\StateStore($this->optionName);
            if (did_action('init')) {
                $this->loadTextDomain();
            } else {
            ...
            if ($this->wpCliCheckTrigger === null && defined('WP_CLI')) {
                $this->wpCliCheckTrigger = new \YahnisElsts\PluginUpdateChecker\v5p5\WpCliCheckTrigger($this->componentType, $this->scheduler);
            }
        }
        /**
         * @internal
        ...
        public function excludeEntityFromWordPressAPI($args, $url)
        {
            ...
            if (!isset($parsedUrl['path']) || !\YahnisElsts\PluginUpdateChecker\v5p5\Utils::startsWith($parsedUrl['path'], $expectedPathPrefix)) {
                return $args;
            }
         ...
         */
        protected function fixSupportedWordpressVersion(\YahnisElsts\PluginUpdateChecker\v5p5\Metadata $update = null)
        {
        ...
        {
            if (class_exists('RH\AdminUtils\Scoped\Debug_Bar', \false) && class_exists('RH\AdminUtils\Scoped\Debug_Bar_Panel', \false) && file_exists(dirname(__FILE__) . '/DebugBar')) {
                $this->debugBarExtension = $this->createDebugBarExtension();
            }
        }
        protected function createDebugBarExtension()
        {
            return new \YahnisElsts\PluginUpdateChecker\v5p5\DebugBar\Extension($this);
        }
        /**
