...
if (!class_exists(\YahnisElsts\PluginUpdateChecker\v5p5\Vcs\BitBucketApi::class, \false)) {
    class BitBucketApi extends \YahnisElsts\PluginUpdateChecker\v5p5\Vcs\Api
    {
        /**
         * @var OAuthSignature
         */
        ...
        public function getBranch($branchName)
        {
            ...
            return new \YahnisElsts\PluginUpdateChecker\v5p5\Vcs\Reference(array('name' => $ref, 'updated' => $branch->target->date, 'downloadUrl' => $this->getDownloadUrl($branch->name)));
        }
        /**
         * Get a specific tag.
         *
        ...
        public function getTag($tagName)
        {
            ...
            return new \YahnisElsts\PluginUpdateChecker\v5p5\Vcs\Reference(array('name' => $tag->name, 'version' => ltrim($tag->name, 'v'), 'updated' => $tag->target->date, 'downloadUrl' => $this->getDownloadUrl($tag->name)));
        }
        /**
