...
if (!class_exists(\YahnisElsts\PluginUpdateChecker\v5p5\Vcs\PluginUpdateChecker::class, \false)) {
    class PluginUpdateChecker extends Plugin\UpdateChecker implements \YahnisElsts\PluginUpdateChecker\v5p5\Vcs\BaseChecker
    {
        use \YahnisElsts\PluginUpdateChecker\v5p5\Vcs\VcsCheckerMethods;
        /**
