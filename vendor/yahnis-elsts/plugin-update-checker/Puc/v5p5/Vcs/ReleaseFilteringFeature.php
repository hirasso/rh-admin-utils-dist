...
if (!trait_exists(\YahnisElsts\PluginUpdateChecker\v5p5\Vcs\ReleaseFilteringFeature::class, \false)) {
    trait ReleaseFilteringFeature
    {
         ...
         */
        protected $releaseFilterByType = \YahnisElsts\PluginUpdateChecker\v5p5\Vcs\Api::RELEASE_FILTER_SKIP_PRERELEASE;
        /**
         ...
         * @return $this
         */
        public function setReleaseFilter($callback, $releaseTypes = \YahnisElsts\PluginUpdateChecker\v5p5\Vcs\Api::RELEASE_FILTER_SKIP_PRERELEASE, $maxReleases = 20)
        {
            if ($maxReleases > 100) {
         ...
         */
        public function setReleaseVersionFilter($regex, $releaseTypes = \YahnisElsts\PluginUpdateChecker\v5p5\Vcs\Api::RELEASE_FILTER_SKIP_PRERELEASE, $maxReleasesToExamine = 20)
        {
        ...
        protected function shouldSkipPreReleases()
        {
            ...
            //more release types.
            return $this->releaseFilterByType !== \YahnisElsts\PluginUpdateChecker\v5p5\Vcs\Api::RELEASE_FILTER_ALL;
        }
        /**
         * @return bool
         */
