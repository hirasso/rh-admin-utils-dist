...
use RH\AdminUtils\Scoped\Parsedown;
if (!class_exists(\YahnisElsts\PluginUpdateChecker\v5p5\Vcs\GitHubApi::class, \false)) {
    class GitHubApi extends \YahnisElsts\PluginUpdateChecker\v5p5\Vcs\Api
    {
        ...
        public function getLatestRelease()
        {
            ...
            foreach ($foundReleases as $release) {
                ...
                $reference = new \YahnisElsts\PluginUpdateChecker\v5p5\Vcs\Reference(array('name' => $release->tag_name, 'version' => $versionNumber, 'downloadUrl' => $release->zipball_url, 'updated' => $release->created_at, 'apiResponse' => $release));
                ...
                if ($this->releaseAssetsEnabled) {
                    ...
                    } else if ($this->releaseAssetPreference === \YahnisElsts\PluginUpdateChecker\v5p5\Vcs\Api::REQUIRE_RELEASE_ASSETS) {
        ...
        public function getLatestTag()
        {
            ...
            $tag = $versionTags[0];
            return new \YahnisElsts\PluginUpdateChecker\v5p5\Vcs\Reference(array('name' => $tag->name, 'version' => ltrim($tag->name, 'v'), 'downloadUrl' => $tag->zipball_url, 'apiResponse' => $tag));
        }
        /**
