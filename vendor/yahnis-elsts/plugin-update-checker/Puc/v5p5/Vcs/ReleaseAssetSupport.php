...
if (!trait_exists(\YahnisElsts\PluginUpdateChecker\v5p5\Vcs\ReleaseAssetSupport::class, \false)) {
    trait ReleaseAssetSupport
    {
         ...
         * @var int
         */
        protected $releaseAssetPreference = \YahnisElsts\PluginUpdateChecker\v5p5\Vcs\Api::PREFER_RELEASE_ASSETS;
        /**
         ...
         */
        public function enableReleaseAssets($nameRegex = null, $preference = \YahnisElsts\PluginUpdateChecker\v5p5\Vcs\Api::PREFER_RELEASE_ASSETS)
        {
