...
if (!class_exists(\YahnisElsts\PluginUpdateChecker\v5p5\Vcs\GitLabApi::class, \false)) {
    class GitLabApi extends \YahnisElsts\PluginUpdateChecker\v5p5\Vcs\Api
    {
        use \YahnisElsts\PluginUpdateChecker\v5p5\Vcs\ReleaseAssetSupport;
        use \YahnisElsts\PluginUpdateChecker\v5p5\Vcs\ReleaseFilteringFeature;
        /**
        ...
        public function getLatestRelease()
        {
            ...
            foreach ($releases as $release) {
                ...
                return new \YahnisElsts\PluginUpdateChecker\v5p5\Vcs\Reference(array('name' => $release->tag_name, 'version' => $versionNumber, 'downloadUrl' => $downloadUrl, 'updated' => $release->released_at, 'apiResponse' => $release));
            }
            return null;
        }
        /**
        ...
        protected function findReleaseDownloadUrl($release)
        {
            if ($this->releaseAssetsEnabled) {
                ...
                if ($this->releaseAssetPreference === \YahnisElsts\PluginUpdateChecker\v5p5\Vcs\Api::REQUIRE_RELEASE_ASSETS) {
        ...
        public function getLatestTag()
        {
            ...
            $tag = $versionTags[0];
            return new \YahnisElsts\PluginUpdateChecker\v5p5\Vcs\Reference(array('name' => $tag->name, 'version' => ltrim($tag->name, 'v'), 'downloadUrl' => $this->buildArchiveDownloadUrl($tag->name), 'apiResponse' => $tag));
        }
        /**
        ...
        public function getBranch($branchName)
        {
            ...
            $reference = new \YahnisElsts\PluginUpdateChecker\v5p5\Vcs\Reference(array('name' => $branch->name, 'downloadUrl' => $this->buildArchiveDownloadUrl($branch->name), 'apiResponse' => $branch));
        ...
        public function enableReleasePackages()
        {
            $this->enableReleaseAssets(
                /** @lang RegExp */
                '/\.zip($|[?&#])/i',
                \YahnisElsts\PluginUpdateChecker\v5p5\Vcs\Api::REQUIRE_RELEASE_ASSETS
            );
        }
