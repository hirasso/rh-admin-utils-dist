...
if (!class_exists(\YahnisElsts\PluginUpdateChecker\v5p5\Plugin\Update::class, \false)) {
    /**
    ...
    class Update extends BaseUpdate
    {
        ...
        public static function fromJson($json)
        {
            ...
            $pluginInfo = \YahnisElsts\PluginUpdateChecker\v5p5\Plugin\PluginInfo::fromJson($json);
            if ($pluginInfo !== null) {
