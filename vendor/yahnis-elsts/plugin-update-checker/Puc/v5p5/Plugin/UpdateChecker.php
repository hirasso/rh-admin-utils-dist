...
if (!class_exists(\YahnisElsts\PluginUpdateChecker\v5p5\Plugin\UpdateChecker::class, \false)) {
    /**
    ...
    class UpdateChecker extends BaseUpdateChecker
    {
        ...
        public function __construct($metadataUrl, $pluginFile, $slug = '', $checkPeriod = 12, $optionName = '', $muPluginFile = '')
        {
            ...
            $this->extraUi = new \YahnisElsts\PluginUpdateChecker\v5p5\Plugin\Ui($this);
        }
        /**
        ...
        {
            list($pluginInfo, $result) = $this->requestMetadata(\YahnisElsts\PluginUpdateChecker\v5p5\Plugin\PluginInfo::class, 'request_info', $queryArgs);
            if ($pluginInfo !== null) {
        ...
        public function requestUpdate()
        {
            ...
            $update = \YahnisElsts\PluginUpdateChecker\v5p5\Plugin\Update::fromPluginInfo($pluginInfo);
        ...
        {
            return new \YahnisElsts\PluginUpdateChecker\v5p5\Plugin\Package($this->pluginAbsolutePath, $this);
        }
        /**
         * @return Package
         */
