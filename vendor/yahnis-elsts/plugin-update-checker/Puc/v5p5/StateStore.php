...
if (!class_exists(\YahnisElsts\PluginUpdateChecker\v5p5\StateStore::class, \false)) {
    class StateStore
    {
        /**
         ...
         * @return $this
         */
        public function setUpdate(\YahnisElsts\PluginUpdateChecker\v5p5\Update $update = null)
        {
            $this->lazyLoad();
            $this->update = $update;
            return $this;
        ...
        public function save()
        {
            ...
            if (isset($this->update)) {
                ...
                if (\YahnisElsts\PluginUpdateChecker\v5p5\Utils::startsWith($updateClass, $prefix)) {
        ...
        protected function load()
        {
            ...
            if (!is_object($state) || !class_exists(\YahnisElsts\PluginUpdateChecker\v5p5\Utils::class)) {
                $this->lastCheck = 0;
                $this->checkedVersion = '';
                $this->update = null;
                return;
            }
            $this->lastCheck = intval(\YahnisElsts\PluginUpdateChecker\v5p5\Utils::get($state, 'lastCheck', 0));
            $this->checkedVersion = \YahnisElsts\PluginUpdateChecker\v5p5\Utils::get($state, 'checkedVersion', '');
            $this->update = null;
