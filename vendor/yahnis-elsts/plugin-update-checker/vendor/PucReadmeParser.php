...
if (!\class_exists('RH\AdminUtils\Scoped\PucReadmeParser', \false)) {
    /**
    ...
    class PucReadmeParser
    {
        ...
        {
            // whitelisted chars
            if (\function_exists('RH\AdminUtils\Scoped\user_sanitize')) {
                // bbPress native
        ...
        {
            if (\function_exists('RH\AdminUtils\Scoped\encodeit')) {
                // bbPress native
        ...
        {
            if (\function_exists('RH\AdminUtils\Scoped\decodeit')) {
                // bbPress native
     ...
     * It uses Parsedown instead of the "Markdown Extra" parser.
     */
    \class_alias('RH\AdminUtils\Scoped\PucReadmeParser', 'PucReadmeParser', \false);
    // end class
}
