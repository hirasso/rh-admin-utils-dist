...
class PendingReviews extends \RH\AdminUtils\Singleton
{
    ...
    {
        acf_add_local_field_group(array('key' => 'group_rhau_pending_reviews_user_form', 'title' => 'Pending Reviews', 'fields' => array(array('key' => 'field_key_subscribe_to_pending_reviews', 'label' => 'Subscribe to pending reviews', 'name' => 'subscribe_to_pending_reviews', 'type' => 'true_false', 'instructions' => '', 'required' => 0, 'conditional_logic' => 0, 'wrapper' => array('width' => '', 'class' => '', 'id' => ''), 'hide_in' => '', 'message' => '', 'default_value' => 0, 'ui' => 1, 'ui_on_text' => '', 'ui_off_text' => '')), 'location' => array(array(array('param' => 'rhau_user_form_capability', 'operator' => '==', 'value' => 'edit_others_posts'))), 'menu_order' => 0, 'position' => 'acf_after_title', 'active' => \true, 'show_in_rest' => 0));
    }
    /**
