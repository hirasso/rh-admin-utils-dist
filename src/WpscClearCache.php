...
class WpscClearCache extends \RH\AdminUtils\Singleton
{
    ...
    public function replace_wp_super_cache_admin_bar_button($wp_admin_bar)
    {
        ...
        $args = ['parent' => '', 'id' => 'rhau-delete-cache', 'title' => '<span class="ab-icon"></span>' . $text, 'meta' => ['title' => __('Delete Super Cache cached files', 'wp-super-cache'), 'target' => '_self'], 'href' => wp_nonce_url($url, 'rh_clear_cache')];
