...
class ACFCodeField
{
    ...
    {
        acf_render_field_setting($field, array('label' => __('Code field'), 'instructions' => 'Convert to a code field for the selected language', 'name' => 'rhau_code_field', 'type' => 'select', 'allow_null' => 1, 'choices' => ['json' => 'JSON', 'html' => 'HTML']));
        acf_render_field_setting($field, array('label' => __('Code Field: Allow Line Wrapping'), 'instructions' => '', 'name' => 'rhau_code_field_line_wrapping', 'type' => 'true_false', 'ui' => 1, 'conditional_logic' => array([['field' => 'rhau_code_field', 'operator' => '!=empty']])));
    }
    /**
