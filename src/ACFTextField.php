...
class ACFTextField
{
    ...
    {
        acf_render_field_setting($field, ['label' => __('Mask field'), 'instructions' => 'Apply a mask to the field\'s value. See <a href="https://alpinejs.dev/plugins/mask">Alpine.js Mask Plugin</a>', 'name' => 'rhau_mask_field', 'type' => 'text']);
    }
    /**
