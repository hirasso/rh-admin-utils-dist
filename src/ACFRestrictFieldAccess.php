...
class ACFRestrictFieldAccess
{
    ...
    {
        acf_render_field_setting($field, array('label' => __('Roles allowed to edit this field'), 'instructions' => '', 'name' => 'restrict_access', 'type' => 'select', 'choices' => self::get_choices(), 'multiple' => \true, 'ui' => \true), \true);
    }
    /**
