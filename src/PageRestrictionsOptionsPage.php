...
class PageRestrictionsOptionsPage
{
    ...
    public static function register_options_page_settings()
    {
        ...
        add_settings_field(id: 'protected_templates_field', title: 'Protected Page Templates', callback: [__CLASS__, 'protected_templates_field_callback'], page: 'rhau-permissions-section', section: 'rhau_restrictions_section', args: []);
    }
    /**
