...
class ACFOembedWhitelist
{
    ...
    {
        acf_render_field_setting($field, ['label' => __('Whitelist'), 'instructions' => 'Comma-separated list of allowed hosts, for example <code>vimeo.com,youtube.com</code>', 'name' => 'rhau_oembed_whitelist', 'type' => 'text']);
    }
    /**
