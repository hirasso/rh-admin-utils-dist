...
use RH\AdminUtils\YahnisElsts\PluginUpdateChecker\v5p5\Metadata;
    ...
    class PluginInfo extends Metadata
    {
        ...
        protected function validateMetadata($apiResponse)
        {
            if (!isset($apiResponse->name, $apiResponse->version) || empty($apiResponse->name) || empty($apiResponse->version)) {
                return new \RH\AdminUtils\WP_Error('puc-invalid-metadata', "The plugin metadata file does not contain the required 'name' and/or 'version' keys.");
            }
            return \true;
        }
        /**
