...
use RH\AdminUtils\YahnisElsts\PluginUpdateChecker\v5p5\OAuthSignature;
...
if (!class_exists(BitBucketApi::class, \false)) {
    class BitBucketApi extends Api
    {
        ...
        public function api($url, $version = '2.0')
        {
            ...
            $error = new \RH\AdminUtils\WP_Error('puc-bitbucket-http-error', sprintf('BitBucket API error. Base URL: "%s",  HTTP status code: %d.', $baseUrl, $code));
