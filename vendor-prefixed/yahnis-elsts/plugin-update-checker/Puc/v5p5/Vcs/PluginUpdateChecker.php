...
namespace RH\AdminUtils\YahnisElsts\PluginUpdateChecker\v5p5\Vcs;

use RH\AdminUtils\YahnisElsts\PluginUpdateChecker\v5p5\Plugin;
    ...
    class PluginUpdateChecker extends Plugin\UpdateChecker implements BaseChecker
    {
        ...
        public function requestInfo($unusedParameter = null)
        {
            ...
            if ($updateSource) {
                ...
                do_action('puc_api_error', new \RH\AdminUtils\WP_Error('puc-no-update-source', 'Could not retrieve version information from the repository. ' . 'This usually means that the update checker either can\'t connect ' . 'to the repository or it\'s configured incorrectly.'), null, null, $this->slug);
                return null;
            }
            ...
            if (empty($info->version)) {
                do_action('puc_api_error', new \RH\AdminUtils\WP_Error('puc-no-plugin-version', 'Could not find the version number in the repository.'), null, null, $this->slug);
                return null;
            }
