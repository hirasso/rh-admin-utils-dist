...
namespace RH\AdminUtils\YahnisElsts\PluginUpdateChecker\v5p5\DebugBar;

use RH\AdminUtils\YahnisElsts\PluginUpdateChecker\v5p5\UpdateChecker;
if (!class_exists(Panel::class, \false) && class_exists('RH\AdminUtils\Debug_Bar_Panel', \false)) {
    class Panel extends \RH\AdminUtils\Debug_Bar_Panel
    {
        /** @var UpdateChecker */
        ...
        private function displayStatus()
        {
            ...
            if (function_exists('RH\AdminUtils\get_submit_button')) {
