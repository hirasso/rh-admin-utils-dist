...
if (!\class_exists('RH\AdminUtils\PucReadmeParser', \false)) {
    /**
    ...
    class PucReadmeParser
    {
        ...
        {
            // whitelisted chars
            if (\function_exists('RH\AdminUtils\user_sanitize')) {
                // bbPress native
        ...
        function filter_text($text, $markdown = \false)
        {
            ...
            if ($markdown) {
                // Parse markdown.
                if (!\class_exists('RH\AdminUtils\Parsedown', \false)) {
        ...
        {
            if (\function_exists('RH\AdminUtils\encodeit')) {
                // bbPress native
        ...
        {
            if (\function_exists('RH\AdminUtils\decodeit')) {
                // bbPress native
     ...
     * It uses Parsedown instead of the "Markdown Extra" parser.
     */
    \class_alias('RH\AdminUtils\PucReadmeParser', 'PucReadmeParser', \false);
    // end class
}
